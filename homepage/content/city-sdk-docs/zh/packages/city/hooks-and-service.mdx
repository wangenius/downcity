...
service 负责把能力挂进 City，真正的产品调用入口仍然是 [@downcity/city](/zh/city-sdk-docs/packages/city/city)。

## 继续阅读

- 想看 town 端怎么统一调用 service，读 [@downcity/city](/zh/city-sdk-docs/packages/city/city)
