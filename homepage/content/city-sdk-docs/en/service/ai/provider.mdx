...
---
 ...
 POST /v1/ai/language-model/stream → native CityModel LanguageModelV3 path
...
`text()`, `stream()`, and the native CityModel pathway all reuse this factory.
