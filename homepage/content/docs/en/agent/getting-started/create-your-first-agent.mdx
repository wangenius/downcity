...
- `town` installed
- a project directory
- at least one usable model in the shared model catalog

If your shared model catalog is not ready yet, set that up first and then come back here.
...
It creates the project scaffold and the minimum runtime structure. It does not automatically create your shared model catalog or external chat credentials.
