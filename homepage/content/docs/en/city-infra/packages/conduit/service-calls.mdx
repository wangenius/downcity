...
description: "How @downcity/conduit unifies AI service, custom service, and service calls."
---

The easiest mistake with `@downcity/conduit` is to notice only `client.ai.*` and assume the package is just "an AI SDK."
...
This is a business service you registered into InfraRuntime yourself.
...
A service is not a separate API family. It is still just a service mounted inside InfraRuntime.
...
Because a product frontend should not need to learn three separate systems:
