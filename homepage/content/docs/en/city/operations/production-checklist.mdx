...
- The bay table uses an explicit database URL.
- before hooks block over-quota users.
- after hooks record usage and error clues.

## Multi-bay setup

- `bay_id` clearly separates bays.
- Usage records include `bay_id`, `user_id`, and `model`.
- Different bays have default quota strategies.
