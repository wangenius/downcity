...
description: "The boundary between downcity, Admin Visa, and direct database inspection, and when the CLI is the better tool."
---

The CLI and `Admin Visa` can both help you manage City, but they are better at different kinds of operational work.
...
move toward `Admin Visa` or a trusted script.

## CLI, Admin Visa, and direct DB inspection each fit different work
...
If you operate many bays, services, or model configurations, it remains a frequent operations entry.

### `Admin Visa` is not just a more advanced CLI

They are different modes:

- `Admin Visa`: trusted programmatic management
