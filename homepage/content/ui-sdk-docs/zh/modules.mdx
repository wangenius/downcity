...
- 用途：展示多个 agents 的像素化 game world，支持固定 25 x 16 tile 画布、Smallville 风格小镇 atlas、开放式状态建筑、室内平面图 room、portal rail、键盘地图控制、sprite 巡游、quest path、quest ledger、mini-map、codex log 和聚焦查看
