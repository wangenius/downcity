...
- the current local SDK session prompt path does not automatically inject `plugin.system()`
...
- [NotesPlugin scenario](/en/docs/agent/plugins/examples/notes-plugin)
...
- [RoleResolverPlugin scenario](/en/docs/agent/plugins/examples/role-resolver-plugin)
- [SnapshotHttpPlugin scenario](/en/docs/agent/plugins/examples/snapshot-http-plugin)
- [Plugin plus service composition](/en/docs/agent/plugins/examples/plugin-service-composition)
