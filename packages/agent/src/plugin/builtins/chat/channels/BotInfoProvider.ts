...
import { FeishuBotInfoProvider } from "@/plugin/builtins/chat/channels/feishu/BotInfo.js";
import { QqBotInfoProvider } from "@/plugin/builtins/chat/channels/qq/BotInfo.js";
import { TelegramBotInfoProvider } from "@/plugin/builtins/chat/channels/telegram/BotInfo.js";
import type {
  ChatBotInfoResolveInput,
  ChatBotInfoResult,
  ChatChannelBotInfoProvider,
} from "@/plugin/builtins/chat/types/BotInfo.js";
