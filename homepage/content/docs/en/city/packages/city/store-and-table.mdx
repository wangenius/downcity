...
You should still prefer services, and `Admin Gate` for studio-facing or managed entry points.

### Frontends should not treat tables as their API

Studio-side callers should continue to use `User Gate` and `Admin Gate`, not raw table access.
