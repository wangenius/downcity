...
- 回调使用箭头函数
- 为公共 API 编写文档
- 在 `package/src` 内可使用 `@/` 路径别名（映射到 `src`），`pnpm build` 会自动回写为 `bin` 中可运行的相对路径
...
- [Service](/zh/docs/services) - 用户侧 service 文档
- [API 参考](/zh/docs/reference/api) - Runtime HTTP API 文档

### 社区

- [Discord](https://discord.gg/downcity) - 实时聊天
- [GitHub Discussions](https://github.com/wangenius/downcity/discussions) - 问答
