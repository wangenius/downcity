 ...
 */
export declare const CHROME_GUTTER = 1;
/**
 * tool 结果折叠时默认预览行数。
 ...
 * 会话选择器每页大小。
 */
export declare const SESSION_PICKER_PAGE_SIZE = 5;
/**
 * 会话选择器最大可见行数。
 */
export declare const SESSION_PICKER_MAX_VISIBLE = 5;
