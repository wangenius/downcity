...
- 回调使用箭头函数
- 为公共 API 编写文档
- 在 `packages/downcity/src` 内可使用 `@/` 路径别名（映射到 `src`），`pnpm build` 会自动回写为 `bin` 中可运行的相对路径
...
- [架构](/zh/docs/concepts/architecture) - 系统架构
- [Plugin 命令](/zh/docs/commands/plugin/plugin) - 用户侧 plugin 命令文档
- [API 参考](/zh/docs/reference/api) - Runtime HTTP API 文档

### 社区

- [Discord](https://discord.gg/downcity) - 实时聊天
- [Telegram 社区群组](https://t.me/+iozIHyXr-BJhNjE1) - 问答
- [GitHub Issues](https://github.com/wangenius/downcity/issues) - Bug 报告
...
贡献者在以下地方得到认可：
- [贡献者](https://github.com/wangenius/downcity/graphs/contributors)
- 发布说明
- 年度亮点
...
1. 查找 [good first issues](https://github.com/wangenius/downcity/labels/good-first-issue)
2. 加入 [Discord 社区](https://discord.gg/downcity)
3. 开始编码！🚀
