 ...
 */
import type { CityDeployOptions, CityProjectConfigFile } from "../../types/CityProjectConfig.js";
/**
 * 部署 Cloudflare Workers City 项目。
 */
export declare function deployCloudflareWorkers(config_file: CityProjectConfigFile, options: CityDeployOptions): Promise<void>;
