 ...
 * 运行单选 prompt。
 */
export async function run_select_prompt(question) {
 ...
 * 运行多选 prompt。
 */
export async function run_multiselect_prompt(question) {
    const choices = question.choices ?? [];
 ...
 * 运行确认 prompt。
 */
export async function run_confirm_prompt(question) {
