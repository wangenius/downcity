 ...
 * 加载 City 项目目录下的 `.env`。
 */
export function loadFederationProjectEnv(project_dir) {
 ...
 * 读取 City 项目的本地部署环境。
 */
export function readFederationProjectDeployEnv(project_dir) {
    const env_path = join(project_dir, ".env");
 ...
 */
export function writeFederationProjectDeployEnv(env_file, next_env) {
...
//# sourceMappingURL=FederationProjectEnvLoader.js.map