...
- `packages/studio-cli/`: control plane, CLI, project orchestration, model pool, console-facing gateway
- `packages/city/`: infrastructure runtime for services, actions, auth, env, product-scoped access, and routing
...
- `packages/studio-cli` owns control-plane and multi-project coordination
...
packages/studio-cli build -> CLI and control-plane package
