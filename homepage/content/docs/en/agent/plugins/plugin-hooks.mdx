...
1. [Mental model overview](/en/docs/agent/plugins/hooks/overview)
2. [Call flow](/en/docs/agent/plugins/hooks/call-flow)
3. [Pipeline](/en/docs/agent/plugins/hooks/pipeline)
4. [Guard](/en/docs/agent/plugins/hooks/guard)
5. [Effect](/en/docs/agent/plugins/hooks/effect)
6. [Resolve](/en/docs/agent/plugins/hooks/resolve)
7. [How to choose](/en/docs/agent/plugins/hooks/choose-the-right-one)

## Jump straight to scenarios

- [One full message flow](/en/docs/agent/plugins/hooks/examples/end-to-end-message-flow)
- [Why role resolution must stay unique](/en/docs/agent/plugins/hooks/examples/role-resolution-flow)
- [Common bad vs good designs](/en/docs/agent/plugins/hooks/examples/bad-vs-good-design)
