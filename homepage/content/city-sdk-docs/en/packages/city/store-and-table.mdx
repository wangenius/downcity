...
description: "The Federation data layer, table capabilities, and why city, env, and usage facts eventually live in the store layer."
---
...
- For how the database is wired in, read [Federation](/en/city-sdk-docs/packages/city/federation)
- For terminal inspection of these tables, read [CLI](/en/city-sdk-docs/packages/cli)
