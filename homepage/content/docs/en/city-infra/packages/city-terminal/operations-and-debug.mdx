...
description: "The boundary between @downcity/city, AdminClient, and direct database inspection, and when the CLI is the better tool."
---

The CLI and `AdminClient` can both help you manage InfraRuntime, but they are better at different kinds of operational work.
...
1. confirm InfraRuntime is connected to the database you think it is
...
- did the webhook reach InfraRuntime?
...
- For the basic agent entry, read [City Terminal Quickstart](/en/docs/city-infra/packages/city-terminal/quickstart)
- For model and table inspection, read [Models and Tables](/en/docs/city-infra/packages/city-terminal/models-and-tables)
- For the data layer behind those facts, read [Store and Table](/en/docs/city-infra/packages/infra/store-and-table)
