...
> Code references: `packages/downcity/src/services/chat/channels/telegram/Bot.ts`, `packages/downcity/src/services/chat/channels/BaseChatChannel.ts`, `packages/downcity/src/services/chat/runtime/*`, `packages/downcity/src/session/execution/local/SessionEngine.ts`
