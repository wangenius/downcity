...
description: "How @downcity/gate unifies AI service, custom service, and service calls."
---

The easiest mistake with `@downcity/gate` is to notice only `client.ai.*` and assume the package is just "an AI SDK."
...
Because a studio frontend should not need to learn three separate systems:
