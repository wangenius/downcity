...
On the client side, you do not need to care about project prompts, model pool details, or service assembly. You only consume the remote session capability that has already been exposed.
