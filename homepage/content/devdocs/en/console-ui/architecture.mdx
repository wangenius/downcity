...
`products/console-ui/` is the dedicated browser control room for Downcity. It is a frontend workspace, not a copy of backend runtime logic.
...
- view composition stays in `products/console-ui/`
