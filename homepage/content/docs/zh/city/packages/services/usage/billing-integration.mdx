...
- 想理解 usage 记录了什么，读 [Usage 事实模型](/docs/city/packages/services/usage/event-model)
- 想看读取入口，读 [查询与汇总](/docs/city/packages/services/usage/querying-and-summary)
- 想看 Stripe 充值怎么同步到账，读 [@downcity/services](/docs/city/packages/services)
