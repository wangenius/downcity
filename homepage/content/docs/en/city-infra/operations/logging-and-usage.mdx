...
description: How to record AI calls by user, product, and model.
---
...
Once many products share one InfraRuntime, usage data becomes centralized by default, which makes cost analysis and business decisions much easier later.
