...
description: "用 @downcity/cli 查看 models、schema、表数据，以及它和 City 数据层的关系。"
---
...
- 想知道 CLI 在运维里怎么用，读 [运维与排查](/docs/city/packages/cli/operations-and-debug)
