...
description: SDK pathway (User Visa) and OpenAI-compatible pathway (curl / OpenAI SDK / downcity agent) calling examples.
---
...
| Scenario | Pathway |
|---|---|
| Your own bay code, simple prompt → text | SDK |
