...
```text
The current package is centered on AgentRuntime, uses Session and LocalSessionCore as the execution axis, lets services own workflows, and uses plugins only as extensions.
```
