...
> This page remains as a command entry point. For the fuller plugin structure, see [Plugin Overview](/en/docs/agent/plugins/overview), [Plugin Configuration](/en/docs/agent/plugins/configuration), and [Plugin Actions](/en/docs/agent/plugins/plugin-actions).
