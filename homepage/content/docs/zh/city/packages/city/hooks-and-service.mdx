...
所以你看到的 usage、账号、支付，并不是“额外开一套系统”，而是作为扩展点进入同一个 City。
...
service 负责把能力挂进 City，真正的产品调用入口仍然是 [@downcity/gate](/docs/city/packages/gate)。

## 继续阅读

- 想看 studio 端怎么统一调用 service，读 [@downcity/gate](/docs/city/packages/gate)
- 想看账号能力，读 [@downcity/services](/docs/city/packages/services)
- 想看 usage 记录，读 [@downcity/services](/docs/city/packages/services)
- 想看 Stripe 一次性充值，读 [@downcity/services](/docs/city/packages/services)
