...
- `packages/downcity/src/services/shell/runtime/SessionStoreSupport.ts`
- `packages/downcity/src/sessions/tools/shell/ShellHelpers.ts`
- `packages/downcity/src/sessions/acp/AcpSessionRuntime.ts`
