...
import { getControlPlaneRuntimeStatus, restartControlPlaneCommand, runControlPlaneRuntimeCommand, startControlPlaneCommand, stopControlPlaneCommand, } from "./ControlPlaneRuntime.js";
import { controlPlanePublicCommand, } from "./ControlPlanePublicManager.js";
...
import { controlPlaneStatusCommand, printControlPlaneStatusPanel, } from "./ControlPlaneStatus.js";
import { prepareForegroundAgent, ensureRegisteredAgentProjectRoot, restartTownRuntimeCommand, runTownRuntimeCommand, startTownRuntimeCommand, stopTownRuntimeCommand, } from "./ControlPlaneProcess.js";
import { shouldAutoStartControlPlaneFromPersistedMode, } from "./ControlPlanePublicMode.js";
/**
 ...
 */
export function registerControlPlaneCommands(program, context) {
    program
        .command("init")
...
//# sourceMappingURL=ControlPlaneCommand.js.map