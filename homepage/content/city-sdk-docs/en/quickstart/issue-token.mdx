...
description: Give the product client a user-scoped credential that can call the shared runtime.
---
...
Return `user.user_token` and `town.town_id` to the product client.
