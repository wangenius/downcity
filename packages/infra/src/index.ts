...
// ===========================================================================
// 场景 1：创建 InfraRuntime 实例
// ===========================================================================

export { InfraRuntime } from "./core/base/base.js";
export type { InfraRuntimeOptions, InfraHealthStatus } from "./core/types.js";
...
export type { Product, ProductCreateInput, ProductStatus } from "./service/products/types.js";
...
export type { InfraTableApi } from "./store/table-api.js";
export type { InfraUserSchemaInput } from "./store/types.js";
