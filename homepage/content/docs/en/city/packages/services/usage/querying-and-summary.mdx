...
description: "The usage query surface exposed by @downcity/services, and how studio-side and admin-side callers read it."
---
...
- admin-side: which studios, models, and users are consuming resources?
...
### Studio-side callers can read usage too

Usage is not only internal operational data. It can be part of the studio experience.
...
- For what usage actually records, read [Usage Event Model](/en/docs/city/packages/services/usage/event-model)
- For how usage combines with charging logic, read [Billing Integration](/en/docs/city/packages/services/usage/billing-integration)
