...
Downcity lets a new product start from the frontend, extension, or app and connect to an already deployed InfraRuntime. You can validate the product UX first, then decide how much product-specific backend you really need.
...
- returning `user_token + product_id` to the client
