...
description: "The boundary between downcity, Admin Gate, and direct database inspection, and when the CLI is the better tool."
---

The CLI and `Admin Gate` can both help you manage City, but they are better at different kinds of operational work.
...
move toward `Admin Gate` or a trusted script.

## CLI, Admin Gate, and direct DB inspection each fit different work
...
### `Admin Gate` is not just a more advanced CLI

They are different modes:

- `Admin Gate`: trusted programmatic management
