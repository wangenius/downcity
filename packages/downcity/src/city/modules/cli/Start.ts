...
import { getProfileMdPath, getDowncityJsonPath } from "@/city/runtime/env/Paths.js";
import { startDaemonProcess } from "@/city/runtime/daemon/Manager.js";
import { buildRunArgsFromOptions } from "@/city/runtime/daemon/CliArgs.js";
import type { StartOptions } from "@/shared/types/Start.js";
import { isConsoleRunning } from "@/city/runtime/console/ConsoleRuntime.js";
...
export async function startCommand(
  ...
  // 计算当前 CLI 的入口路径（编译后是 `bin/city/modules/cli/Index.js`）。
