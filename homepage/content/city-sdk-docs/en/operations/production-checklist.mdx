...
- The town table uses an explicit database URL.
- before hooks block over-quota users.
- after hooks record usage and error clues.

## Multi-town setup

- `town_id` clearly separates towns.
- Usage records include `town_id`, `user_id`, and `model`.
- Different towns have default quota strategies.
