...
- you want town business actions, not raw model inference only
...
That is why the town side can stay unified:
...
### Scenario 1: town business action
...
From the town side, both still go through `client.service("service_id").action("action_id").invoke(...)`.
...
- For hooks and extension around actions, read [Hooks and Service Mounting](/en/city-sdk-docs/packages/city/hooks-and-service)
- For town-side calling, read [@downcity/city](/en/city-sdk-docs/packages/city/city)
