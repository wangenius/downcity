...
It does not handle subscriptions or entitlements.
...
If you deploy on a bindings-based runtime such as Workers, provide both `STRIPE_SECRET_KEY` and `STRIPE_WEBHOOK_SECRET` to the host runtime explicitly.
