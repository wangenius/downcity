 ...
 */
export function createVersionBanner(version, action, command_name = resolveCurrentCommandName()) {
    return async (...args) => {
 ...
 * 从项目根目录推断 agent id。
 */
export function resolveAgentId(projectRoot) {
 ...
 * 注入当前 agent 执行上下文。
 */
export function injectAgentContext(pathInput = ".") {
...
//# sourceMappingURL=IndexSupport.js.map