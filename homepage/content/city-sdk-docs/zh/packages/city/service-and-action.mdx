...
- 想知道 hook 和 service 怎么围绕 Action 工作，读 [Hook 与服务挂载](/zh/city-sdk-docs/packages/city/hooks-and-service)
- 想知道产品端怎么调用这些能力，读 [@downcity/city](/zh/city-sdk-docs/packages/city/federation)
- 想看更底层 API 选项，读 [City API](/zh/city-sdk-docs/reference/federation)
