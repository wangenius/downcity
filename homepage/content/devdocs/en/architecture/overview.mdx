...
- `cli/bay/`: local Agent host, Console gateway, model pool, project orchestration, and daemon control
- `packages/city/`: City runtime plus Gate access SDK for services, actions, auth, env, bay-scoped access, routing, and HTTP calls
...
cli/bay build -> local Bay host command
