...
import { message_accent, message_title, render_loading, render_nav, render_option_detail, show_content, text_footer_text, } from "../../federation/tui/AdminTuiRender.js";
import { next_breadcrumb_parts, run_sidebar_select, run_text_in_content, } from "../../federation/tui/AdminTuiInput.js";
/**
...
export function create_admin_tui_runtime(title = "Admin") {
    ...
    const runtime = {
        ...
        async select_nav(nav_title, options) {
            ...
            const selected_index = resolve_selectable_index_from_input(options, selected_index_by_breadcrumb.get(breadcrumb_key));
...
function resolve_selectable_index_from_input(options, stored_index) {
