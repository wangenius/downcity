...
- [调用流](/zh/agent-sdk-docs/plugins/hooks/call-flow)
- [Pipeline](/zh/agent-sdk-docs/plugins/hooks/pipeline)
- [Guard](/zh/agent-sdk-docs/plugins/hooks/guard)
- [Effect](/zh/agent-sdk-docs/plugins/hooks/effect)
