...
- Purpose: render a pixel-style game world across multiple agents with a fixed 25 x 16 tile canvas, a Smallville-style town atlas, open state buildings, interior floor-plan rooms, a portal rail, keyboard map control, sprite patrols, quest paths, a quest ledger, a mini-map, a codex log, and focused inspection
