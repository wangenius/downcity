 ...
 *
 * 关键点（中文）
 * - 统一承载 `studio agent` 命令树，避免主入口继续混合 console 与 agent 两套语义。
...
} from "../studio/agent/AgentSelection.js";
import { runInteractiveAgentManager } from "../studio/agent/AgentManager.js";
import { chatCommand } from "../studio/agent/AgentChat.js";
import { agentHistoryCleanCommand } from "../studio/agent/AgentHistory.js";
import { initCommand } from "../studio/agent/Init.js";
import { restartCommand } from "../studio/agent/Restart.js";
import { stopCommand } from "../studio/agent/Stop.js";
import { agentResetCommand } from "../studio/agent/AgentReset.js";
import { runCommand } from "../studio/agent/Run.js";
import { startCommand } from "../studio/agent/Start.js";
import { statusCommand } from "../studio/agent/Status.js";
...
} from "../city/control-plane/ControlPlaneCommand.js";
...
export interface AgentCommandRegistrationContext {
  /** 当前 CLI 版本号。 */
  version: string;
  /** 当前 studio 绑定的 agent runtime 版本号。 */
  agentVersion: string;
...
export function registerAgentCommands(
  ...
  const agent = program
    ...
    .version(`studio ${context.version} (agent ${context.agentVersion})`, "-v, --version")
        ...
        if (options.fix !== true) {
          emitCliBlock({
            ...
            facts: [
              {
                label: "Command",
                value: "studio agent doctor <path> --fix",
              },
            ],
          });
          return;
