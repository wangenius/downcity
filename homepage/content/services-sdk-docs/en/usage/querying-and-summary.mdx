...
- For what usage actually records, read [Usage Event Model](/en/services-sdk-docs/usage/event-model)
- For how usage combines with charging logic, read [Billing Integration](/en/services-sdk-docs/usage/billing-integration)
