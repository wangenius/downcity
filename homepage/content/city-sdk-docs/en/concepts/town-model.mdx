...
> one shared agent runtime serving many AI products and workflows.
...
## Many products, one shared runtime
...
## What should stay in the shared runtime
...
Once the AI call layer is centralized into the shared runtime, a new product usually only needs two steps:
