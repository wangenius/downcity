 ...
 * Compactor 组件抽象类。
 */
export abstract class CompactorComponent extends SessionComponent {
  /**
   * 组件名（由具体实现声明）。
   */
   ...
   * - SessionCore 不感知具体错误文案，只按该布尔结果决定是否重试。
   */
