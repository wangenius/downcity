...
- `town` / Console: the global control plane

## The short version

- `agent` owns how one project runs
- `town` owns which projects exist, which global resources exist, and how they are managed

If you prefer a control-plane vs execution-plane mental model:

- `town` / Console is the control plane
...
- maintaining the shared model catalog
...
2. When you manage shared resources, you use shared runtime capabilities like model catalogs, channel accounts, and Console.

## Common examples

### Model binding

- the model definition lives in the shared model catalog
