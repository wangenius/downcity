...
- The interactive flow now lets you choose an execution mode directly: `Global Model Pool`, `Kimi ACP`, `Claude ACP`, or `Codex ACP`.
...
If you choose ACP mode, initialization can proceed even when the console model pool is empty.
