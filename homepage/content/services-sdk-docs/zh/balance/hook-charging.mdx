...
- `balance.charge({ user_id, amount_microcredits, note, ref, metadata })`

## 继续阅读

- 想理解为什么它是全局钱包，读 [全局钱包模型](/zh/services-sdk-docs/balance/global-wallet)
- 想看充值和历史记录，读 [充值单与流水](/zh/services-sdk-docs/balance/topups-and-ledger)
