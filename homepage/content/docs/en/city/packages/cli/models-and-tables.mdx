...
description: "Use @downcity/cli to inspect models, schema, and table data, and understand how that connects to the City data layer."
---
...
- `@downcity/cli` owns the human inspection and debugging entry
