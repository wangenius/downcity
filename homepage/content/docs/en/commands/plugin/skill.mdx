...
> This page remains as a command entry point. For the fuller plugin structure, see [Plugin Overview](/en/docs/agent/plugins/overview), [Built-in Plugins Today](/en/docs/agent/plugins/built-in-plugins), and [Plugin Actions](/en/docs/agent/plugins/plugin-actions).
