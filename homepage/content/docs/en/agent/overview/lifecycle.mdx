...
This means the project must bind to a model ID from the connected Federation AIService.
...
In background mode, Downcity also maintains daemon state so lifecycle actions can inspect, stop, restart, or repair the process later.
...
- [Agent CLI product docs](/en/docs/reference/cli)
- [Downcity City product docs](/en/docs/reference/cli)
