...
description: Explain why service, plugin, and asset calls do not cross agent environments and how routing works
---
...
- `service`, `plugin`, and `asset` calls stay inside that runtime by default
