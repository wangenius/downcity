...
import type { UserVisaAccessOptions, UserServiceInput, UserServiceSummary } from "./types.js";
import {
  defaultFetch,
  normalizeBaseURL,
  requestJSON,
...
export class UserVisaAccess {
  ...
  constructor(options: UserVisaAccessOptions) {
    if (!options || typeof options !== "object") {
      throw new TypeError("User Visa options are required");
    }
