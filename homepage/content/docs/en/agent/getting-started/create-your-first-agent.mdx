...
- `town` installed
- a project directory
- Town connected to City
- at least one usable model in City AIService

If City AIService is not ready yet, set that up first and then come back here.
...
It creates the project scaffold and the minimum runtime structure. It does not automatically create City models or external chat credentials.
