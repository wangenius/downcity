...
1. start with [Built-in Plugin Overview](/en/docs/agent/plugins/builtins/overview)
...
1. [skill Plugin](/en/docs/agent/plugins/builtins/skill)
2. [web Plugin](/en/docs/agent/plugins/builtins/web)
3. [asr Plugin](/en/docs/agent/plugins/builtins/asr)
4. [tts Plugin](/en/docs/agent/plugins/builtins/tts)
5. [workboard Plugin](/en/docs/agent/plugins/builtins/workboard)
6. [auth Plugin](/en/docs/agent/plugins/builtins/auth)
...
- [auth Plugin](/en/docs/agent/plugins/builtins/auth)
- [skill Plugin](/en/docs/agent/plugins/builtins/skill)
- [web Plugin](/en/docs/agent/plugins/builtins/web)
- [asr Plugin](/en/docs/agent/plugins/builtins/asr)
- [tts Plugin](/en/docs/agent/plugins/builtins/tts)
- [workboard Plugin](/en/docs/agent/plugins/builtins/workboard)
...
- [Resolve hook](/en/docs/agent/plugins/hooks/resolve)
- [Pipeline hook](/en/docs/agent/plugins/hooks/pipeline)
- [Plugin HTTP injection](/en/docs/agent/plugins/plugin-http)
