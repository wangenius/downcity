...
Use the interactive `town chat` menu and choose "manage chat accounts → manage access control", or use the CLI directly:
...
When a chat user is denied, the denial message includes a command like `town chat auth set telegram:12345678` that they can forward to an admin.
...
- [Console](/en/products-docs/town-cli/console/console)
