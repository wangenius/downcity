...
- `packages/city/`: City runtime plus Gate access SDK for services, actions, auth, env, studio-scoped access, routing, and HTTP calls
...
- `packages/city` owns service access over HTTP through Gate exports
...
packages/city build -> runtime and Gate SDK package
