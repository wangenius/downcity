...
function getTimelineVisualTone(roleInput?: string): {
  ...
  if (role === "tool-call") {
    return {
      cardClassName: "border border-border/70 bg-secondary/88 shadow-[inset_0_1px_0_rgba(255,255,255,0.52)] dark:bg-muted/58",
      ...
      textClassName: "font-mono text-[10px] leading-[1.6] text-foreground/96",
    }
  }
  if (role === "tool-result") {
    return {
      cardClassName: "border border-border/55 bg-background shadow-[inset_0_1px_0_rgba(255,255,255,0.34)] dark:bg-background/88",
      ...
      textClassName: "font-mono text-[10px] leading-[1.6] text-foreground/82",
    }
  }
  if (role === "user") {
    return {
