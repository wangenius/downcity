...
- 想理解为什么它是全局钱包，读 [全局钱包模型](/docs/city/packages/services/balance/global-wallet)
- 想看充值和历史记录，读 [充值单与流水](/docs/city/packages/services/balance/topups-and-ledger)
