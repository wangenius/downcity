...
2. [Remote Agent](/en/docs/agent/sdk/remote-agent/quickstart)
3. [Sessions](/en/docs/agent/sdk/sessions/overview)
4. [API reference](/en/docs/agent/sdk/api-reference/agent-class)
