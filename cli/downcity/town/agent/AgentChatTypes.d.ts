 ...
 */
export declare const AGENT_CHAT_DEFAULT_SESSION_ID = "local-cli-chat-main";
/**
 * `town agent chat --new-session` 生成的 session ID 前缀。
 */
export declare const AGENT_CHAT_NEW_SESSION_ID_PREFIX = "local-cli-chat";
/**
 * `town agent chat` 命令选项。
 */
...
//# sourceMappingURL=AgentChatTypes.d.ts.map