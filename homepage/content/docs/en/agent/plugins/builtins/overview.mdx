...
- To add skill catalog behavior: read [skill Plugin](/en/docs/agent/plugins/builtins/skill)
- To add web strategy: read [web Plugin](/en/docs/agent/plugins/builtins/web)
- To handle spoken input: read [asr Plugin](/en/docs/agent/plugins/builtins/asr)
- To generate spoken output: read [tts Plugin](/en/docs/agent/plugins/builtins/tts)
- To build a status surface or workboard UI: read [workboard Plugin](/en/docs/agent/plugins/builtins/workboard)
- To control permissions and roles: read [auth Plugin](/en/docs/agent/plugins/builtins/auth)
