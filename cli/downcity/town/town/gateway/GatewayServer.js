...
import { registerAgentSdkPublishRoutes, } from "./api/AgentSdkPublishRoutes.js";
import { buildPlatformAgentsResponse, buildPlatformConfigStatusResponse, buildPlatformModelResponse, inspectPlatformAgentDirectory, listKnownPlatformAgents, readPlatformConfigFileStatus, readRequestedPlatformAgentId, resolvePlatformAgentById, resolveSelectedPlatformAgent, } from "./AgentCatalog.js";
import { executeAgentProjectShellCommand, initializePlatformAgentProject, inspectManagedAgentRestartSafety, pickPlatformAgentDirectoryPath, restartManagedAgentByProjectRoot, startManagedAgentByProjectRoot, stopManagedAgentByProjectRoot, updatePlatformAgentExecution, } from "./AgentActions.js";
import { serveGatewayFrontendPath } from "./FrontendAssets.js";
...
import { GATEWAY_AUTH_ROUTE_POLICIES, createRouteAuthGuardMiddleware, } from "../auth/RoutePolicy.js";
import { resolveTownCliPath } from "../../shared/TownCliPath.js";
const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);
/**
 * 当前 DC 版本号（用于 gateway overview 显示）。
 */
const DC_VERSION = (() => {
...
export class GatewayServer {
    ...
    async serveFrontendPath(c, reqPath) {
        return serveGatewayFrontendPath({
            context: c,
