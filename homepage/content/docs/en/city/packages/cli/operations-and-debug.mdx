...
description: "The boundary between @downcity/cli, AdminClient, and direct database inspection, and when the CLI is the better tool."
---
...
- For the basic agent entry, read [Downcity CLI Quickstart](/en/docs/city/packages/cli/quickstart)
- For model and table inspection, read [Models and Tables](/en/docs/city/packages/cli/models-and-tables)
