...
- For the usage fact model, read [Usage Event Model](/en/payments/usage/event-model)
- For usage read surfaces, read [Querying and Summary](/en/payments/usage/querying-and-summary)
- For Stripe topup syncing, read [@downcity/services](/en/payments)
