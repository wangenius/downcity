...
description: "The boundary between downcity, AdminClient, and direct database inspection, and when the CLI is the better tool."
---
...
- For the basic agent entry, read [City CLI Quickstart](/en/docs/city/packages/cli/quickstart)
