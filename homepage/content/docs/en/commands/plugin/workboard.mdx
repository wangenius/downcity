...
- the map uses a fixed 25 x 16 tile canvas; normal view keeps the full stage visible, while fullscreen uses cover scaling to fill the whole screen and always preserves square pixel blocks
