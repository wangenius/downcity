...
One `sessionId` maps to one `Session` instance.
...
Assembles model, history composer, system composer, compaction composer, and execution composer into a runnable local executor.
