...
description: Understand what the Town managed agent registry stores and how it relates to actual runtime state
---

# Agent Registry

`town agent list` shows the set of agents known to the Town managed agent registry.

## What the registry represents

From a user perspective, it tells you:

- which project agents Town knows about
...
- `town agent list`
- interactive target selection in `town agent start`
...
- [town agent list](/en/docs/agent/cli/lifecycle/list)
