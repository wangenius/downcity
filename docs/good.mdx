...
3. 默认最多同时跑 2 个 lane。配置入口是 `services.chat.queue.maxConcurrency`，默认值在 [Ship.ts](/Users/wangenius/Documents/github/shipmyagent/packages/downcity/src/main/constants/Ship.ts)；worker 在 [AgentRuntime.ts](/Users/wangenius/Documents/github/shipmyagent/packages/downcity/src/agent/AgentRuntime.ts) 启动。
