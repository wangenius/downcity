...
The endpoint returns structured JSON, but only as a public-safe high-level projection. It does not expose internal session, plugin runtime, task, path, or model details.
