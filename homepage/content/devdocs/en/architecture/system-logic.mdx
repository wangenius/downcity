...
5. Infrastructure layer: City runtime, auth, env, town-scoped routing
...
flowchart LR
  ...
  subgraph Infra["Infrastructure"]
    INFRA["City<br/>service runtime / auth / env / towns"]
    SERVICES["Services<br/>accounts / balance / usage / payment"]
    CONDUIT["City<br/>user and admin SDK"]
  end
...
- owns town-scoped auth, runtime env, and built-in town/env tables
