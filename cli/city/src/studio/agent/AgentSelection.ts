 ...
 *
 * 关键点（中文）
 * - 统一承接 `studio agent list` 的 registry 展示逻辑。
 * - 统一承接 `studio agent start` 在省略路径时的目标选择逻辑。
...
import { resolveRunningManagedAgents } from "../../city/control-plane/ControlPlaneProcess.js";
...
/**
 * 为 `studio agent start` 解析最终要启动的项目目录。
 */
