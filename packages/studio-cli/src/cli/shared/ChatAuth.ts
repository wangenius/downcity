...
export function registerChatAuthCommands(chat: Command): void {
  ...
  auth
    ...
    .description("给授权主体设置角色，例如：studio chat auth set telegram:12345678 --path .")
