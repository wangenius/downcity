...
description: "How Service, Action, the unified route space, and AIService relate inside @downcity/infra."
---

`Service` and `Action` are the main business organization units inside `@downcity/infra`.
...
- you want product business actions, not raw model inference only
...
### Scenario 1: product business action
...
- For hooks and extension around actions, read [Hooks and Service Mounting](/en/docs/city-infra/packages/infra/hooks-and-service)
- For product-side calling, read [@downcity/conduit](/en/docs/city-infra/packages/conduit)
