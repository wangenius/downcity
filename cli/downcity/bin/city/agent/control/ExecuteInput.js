...
function normalizeExecuteAttachmentType(value) {
...
function normalizeAttachmentCaption(value) {
...
function inferAttachmentExt(params) {
    ...
    if (params.type === "photo")
        return ".jpg";
    if (params.type === "voice" || params.type === "audio")
        return ".mp3";
...
function resolveAttachmentBytes(attachment) {
...
async function materializeAttachmentContent(params) {
    ...
    if (bytes.length > EXECUTE_ATTACHMENT_MAX_BYTES) {
        throw new Error(`Attachment too large (>${EXECUTE_ATTACHMENT_MAX_BYTES} bytes)`);
    }
...
//# sourceMappingURL=ExecuteInput.js.map