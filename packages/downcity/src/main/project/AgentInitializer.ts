 ...
 *
 * 关键点（中文）
 * - CLI `city agent create` 与 Console UI 共用同一套初始化逻辑，避免模板与目录结构分叉。
...
import { DEFAULT_DOWNCITY_JSON } from "@/main/constants/DowncityDefault.js";
...
} from "@sessions/prompts/common/InitPrompts.js";
