...
import { buildControlRouteAliases, toLimit } from "../../control/CommonHelpers.js";
import { listControlSessionSummaries, readRecentLogs } from "../../control/Helpers.js";
 ...
 * 注册概览与运行态 plugin 路由。
 */
export function registerControlOverviewRoutes(params) {
    const { app } = params;
    for (const routePath of buildControlRouteAliases("/overview")) {
        app.get(routePath, async (c) => {
            try {
                ...
                const taskData = taskResult.data && typeof taskResult.data === "object" && !Array.isArray(taskResult.data)
                    ? taskResult.data
                    : {};
...
//# sourceMappingURL=OverviewRoutes.js.map