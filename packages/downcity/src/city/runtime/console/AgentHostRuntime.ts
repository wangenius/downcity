 ...
 *
 * 关键点（中文）
 * - main 负责创建这些宿主能力对象，再注入到 AgentState。
 * - services / sessions / plugins 只消费这些对象，不再直接 import `main/*`。
...
import { persistProjectPluginConfig } from "@/city/plugin/ProjectConfigStore.js";
import type {
  AgentAuthRuntime,
  AgentPathRuntime,
