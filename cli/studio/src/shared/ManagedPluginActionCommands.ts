...
const CHAT_PLUGIN_HELP_TEXT = [
  ...
  "  跨 chat 发送请使用 `studio chat send --chat-key <chatKey>`。",
  "  如果要发正文/附件/定时消息，先看 `studio chat send --help` 与 `studio chat react --help`。",
  "",
  "Common examples:",
  "  studio chat send --text 'done'",
  "  studio chat send --chat-key <chatKey> --text 'done'",
  "  studio chat react --message-id <messageId> --emoji '✅'",
  "  studio chat context",
  "  studio chat history --limit 30",
].join("\n");
