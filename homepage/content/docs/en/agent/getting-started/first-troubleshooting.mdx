...
- `town agent status` shows `not initialized`
...
- run `town city status`
- confirm that the model ID exists in City AIService
...
- `town agent chat` cannot connect
...
3. confirm City connection and model binding
