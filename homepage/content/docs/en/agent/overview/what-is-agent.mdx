...
- a project-level assistant that holds sessions, reads project config, calls tools, and runs runtime plugins
...
- starting enabled project runtime plugins
...
- you want to control tools, runtime plugins, and session lifecycle programmatically
