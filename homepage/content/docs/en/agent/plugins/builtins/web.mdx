...
- [Built-in Plugin Overview](/en/docs/agent/plugins/builtins/overview)
- [Plugin configuration](/en/docs/agent/plugins/configuration)
- [Plugin system](/en/docs/agent/plugins/plugin-system)
- [Plugin actions](/en/docs/agent/plugins/plugin-actions)
