...
import { createAgentChatSessionId, createRemoteAgent, createRemoteChatSession, getOrCreateRemoteSession, buildAgentChatFailureText, } from "../../city/agent/AgentChatRemote.js";
 ...
 */
export function resolveAgentChatSessionOptions(input) {
...
export function hasExplicitSessionSelection(input) {
    return Boolean(String(input.sessionId || "").trim() || input.newSession === true);
}
export async function resolveChatTargetAgentId(inputId) {
...
export async function resolveAgentChatTarget(agentIdInput, sessionOptions) {
...
export function printAssistantReply(replyText) {
...
//# sourceMappingURL=AgentChatHelpers.js.map