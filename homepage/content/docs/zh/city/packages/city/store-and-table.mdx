---
title: Store 与 Table
description: "City 的数据层、表能力和为什么 studio、env、usage 最终都会落到 store 层。"
---
...
如果你想看更底层方法签名，去读 [Runtime API](/docs/city/reference/runtime-api) 和 [City API](/docs/city/reference/city-runtime)。
...
- 想知道数据库是怎么接进来的，读 [City 运行时](/docs/city/packages/city/city-runtime)
- 想在终端里查这些表，读 [@downcity/studio-cli](/docs/city/packages/studio-cli-terminal)
