...
- the project uses one model from the connected Federation AIService
- the project stores only the `modelId`
- provider details, credentials, and model names live in City
...
3. resolve the final model from Federation AIService
...
- multiple projects can share one City model definition
