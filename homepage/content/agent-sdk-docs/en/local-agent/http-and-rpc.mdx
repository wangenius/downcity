...
## Relationship with Town and RemoteAgent

- `town agent start` wires `Agent + AgentRPC + AgentHTTP.router()` together and adds Town's own control / static routes on top.
