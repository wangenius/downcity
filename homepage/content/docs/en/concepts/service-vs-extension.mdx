...
| Config scope | `ship.json.services.*` (per-project) | `~/.ship/ship.json.extensions.*` (console-global) |
...
- Note:
  ...
  - extension switches/config are managed at console-global layer (`~/.ship/ship.json.extensions.*`).
