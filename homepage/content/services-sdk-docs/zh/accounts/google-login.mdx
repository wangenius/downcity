...
- 想看 OAuth 整体链路，继续读 [OAuth 与 Session](/zh/services-sdk-docs/accounts/oauth-and-session)
- 如果你还要接微信网站登录，继续读 [微信登录配置](/zh/services-sdk-docs/accounts/wechat-login)
- 想看完整接入流程，读 [Accounts 服务](/zh/services-sdk-docs/accounts)
