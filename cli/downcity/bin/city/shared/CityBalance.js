 ...
 */
export async function readCurrentCityBalance() {
 ...
 */
export async function rechargeCurrentCityUser(input) {
 ...
 * 输出当前 user 余额。
 */
export async function emitCurrentCityBalance() {
 ...
 * 输出当前 user 充值结果。
 */
export function emitCityRechargeResult(result) {
