...
- if the current turn can still absorb new user input, it merges it; after the message is persisted, `subscribe()` receives a completed action event titled `Session steer message sent`
