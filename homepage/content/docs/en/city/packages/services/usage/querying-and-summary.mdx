...
description: "The usage query surface exposed by @downcity/services, and how bay-side and admin-side callers read it."
---
...
- admin-side: which bays, models, and users are consuming resources?
...
### Bay-side callers can read usage too

Usage is not only internal operational data. It can be part of the bay experience.
