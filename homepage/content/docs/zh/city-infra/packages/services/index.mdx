...
- `paymentService()`：统一暴露当前 InfraRuntime 开放的支付方式
...
1. 账号能力读 [Accounts 服务](/docs/city-infra/packages/services/accounts)
2. 余额能力读 [Balance 服务](/docs/city-infra/packages/services/balance)
3. 使用记录读 [Usage 服务](/docs/city-infra/packages/services/usage)
4. Stripe 充值读 [Stripe Payment 服务](/docs/city-infra/packages/services/payment-stripe)
