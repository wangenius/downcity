...
The public repository includes `cities/edge` as a developer starter. Downcity's private official Worker implementation lives outside the public repository.
...
## Use `cities/edge` as a starter

The starter implementation in [cities/edge/src/index.ts](/Users/wangenius/Documents/github/downcity/cities/edge/src/index.ts:1) covers the integration details most projects need:
...
- If you want a complete starter implementation, open [cities/edge/src/index.ts](/Users/wangenius/Documents/github/downcity/cities/edge/src/index.ts:1)
