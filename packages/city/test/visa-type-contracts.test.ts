...
declare const client: Visa<"user">;
declare const admin: Visa<"admin">;
declare const user_visa: Visa<"user">;
declare const admin_visa: Visa<"admin">;
...
const visaPaymentMethodsContract: Promise<UserPaymentMethod[]> = user_visa.payment.methods();
const visaAdminServicesContract: Promise<UserServiceSummary[]> = admin_visa.listServices();
const visaInstructionContract: Promise<string> = admin_visa.instruction();
void visaPaymentMethodsContract;
void visaAdminServicesContract;
void visaInstructionContract;
