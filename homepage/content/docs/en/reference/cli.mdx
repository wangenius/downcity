...
The unified `downcity` command (alias `city`) hosts local Agents and administers the City. For concrete flags, use the local command help from the installed CLI; the City SDK docs cover the City-side surface.
