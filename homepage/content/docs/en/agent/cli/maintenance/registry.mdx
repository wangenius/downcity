...
`bay agent list` shows the set of agents known to the city registry.
...
- `bay agent list`
- interactive target selection in `bay agent start`
- `bay agent chat --to <name>`
...
- [bay agent list](/en/docs/agent/cli/lifecycle/list)
