...
- 负责消息历史
- 负责 run
- 负责 persistor、compact、tools、prompt、model 协调
...
- runtime 中心已经是 `AgentState`
- session 已经收敛到 `SessionStore` 一套主链
...
- `SessionStore -> SessionRuntimeStore -> SessionCore`
