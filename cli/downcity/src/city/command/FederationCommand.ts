...
import {
  ...
  emitCityUserWhoami,
  emit_federation_list,
  run_federation_join_command,
  run_federation_leave_command,
  run_federation_login_command,
 ...
 */
export function register_federation_command(program: Command): void {
