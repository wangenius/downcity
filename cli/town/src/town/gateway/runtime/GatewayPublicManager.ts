...
import {
  ...
  writeGatewayPublicModeSetting,
  type GatewayPublicModeSetting,
} from "./GatewayPublicMode.js";
...
function toPublicModeSummary(setting: GatewayPublicModeSetting): string {
...
async function applyPublicModeSetting(
  setting: Partial<GatewayPublicModeSetting>,
  cliPath: string,
): Promise<void> {
