...
This layer does not grant bay access and does not mirror every Stripe object.
...
Other Stripe events can be ignored until the bay explicitly needs a new payment flow.
