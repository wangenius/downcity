---
title: 组合方式与常见错误
description: "@downcity/conduit 在真实产品里的常见组合，以及 token、model、service 相关错误的排查思路。"
---
...
- `user_token` 没传
- token 已过期
- token 对应的 `product_id` 不匹配
- product 已暂停

## 404 最常见原因

- 目标 service 没挂进 InfraRuntime
- Action 路径写错
...
3. 再看 `product_id`、`user_token`、service id、action id、model id 是否一致
