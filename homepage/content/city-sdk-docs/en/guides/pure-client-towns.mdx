...
Downcity lets a new product start from the frontend, extension, or app and connect to an already deployed shared runtime. You can validate the product UX first, then decide how much product-specific backend you really need.
