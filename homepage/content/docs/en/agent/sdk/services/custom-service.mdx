...
But note: the current local SDK session path does not automatically inject `service.system()`. That is important enough to have its own page.
...
- [NotesService scenario](/en/docs/agent/sdk/services/examples/notes-service)
- [CacheService scenario](/en/docs/agent/sdk/services/examples/cache-service)
- [WebhookRelayService scenario](/en/docs/agent/sdk/services/examples/webhook-relay-service)
- [Service plus tool composition](/en/docs/agent/sdk/services/examples/service-tool-composition)

## Continue reading

- [Service lifecycle](/en/docs/agent/sdk/services/service-lifecycle)
- [Service actions](/en/docs/agent/sdk/services/service-actions)
