 ...
 */
export async function readCurrentTownCityBalance(): Promise<TownCityBalanceAccount> {
...
): Promise<TownCityRechargeResult> {
 ...
 * 输出当前 user 余额。
 */
export async function emitCurrentTownCityBalance(): Promise<void> {
