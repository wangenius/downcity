 ...
 *
 * 关键点（中文）
 * - Town runtime是强依赖：`town start` + `town agent start` 都会使用这里的默认配置。
 ...
 * 平台初始化入口。
 */
export declare function controlPlaneInitCommand(): Promise<void>;
//# sourceMappingURL=ControlPlaneInit.d.ts.map