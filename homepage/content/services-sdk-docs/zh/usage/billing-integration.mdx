...
- 想理解 usage 记录了什么，读 [Usage 事实模型](/zh/services-sdk-docs/usage/event-model)
- 想看读取入口，读 [查询与汇总](/zh/services-sdk-docs/usage/querying-and-summary)
- 想看 Stripe 充值怎么同步到账，读 [@downcity/services](/zh/services-sdk-docs)
