...
import type { CreateFederationBureauTokenInput } from "@/federation/types/FederationBureau.js";
import { CliError } from "@/shared/CliError.js";
import { emitCliBlock, emitCliList } from "@/shared/CliReporter.js";
import { t } from "@/shared/CliLocale.js";

/** 为当前 active Federation 创建并登记 Bureau Token。 */
export async function create_federation_bureau_token(
  input: CreateFederationBureauTokenInput,
): Promise<void> {
