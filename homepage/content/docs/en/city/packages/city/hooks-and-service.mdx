...
- the capability should be reused across many towns
- it is more than before or after logic and needs its own service or tables
- you want town-side callers to reach it through a stable service boundary
...
## How town-side callers reach services

Once mounted, services still look like normal services from the town side:
...
Services add capability into City. The town-side calling surface is still [@downcity/city](/en/docs/city/packages/city/city).

## Read next

- For unified town-side service calls, read [@downcity/city](/en/docs/city/packages/city/city)
