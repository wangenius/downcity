...
The server-side runtime class is `Federation` (also called the City runtime in these docs); product clients use the `City` client to reach it. See [Federation and City](/en/city-sdk-docs/concepts/federation) for the distinction.
