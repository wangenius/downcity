...
- the main stage behaves like a pixel-style world atlas: start with public state clusters, then enter a cluster room
- agents appear as sprites that patrol corridors, gates, and stations
