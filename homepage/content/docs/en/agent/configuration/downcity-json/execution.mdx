...
description: How an Agent project binds to a model in the Studio global model pool
---
...
- `modelId` points to a model ID in the Studio global model pool
...
in the Studio global model pool.
