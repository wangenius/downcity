...
- `packages/cli/`: control plane, CLI, project orchestration, model pool, console-facing gateway
...
- `packages/cli` owns control-plane and multi-project coordination
...
packages/cli build -> CLI and control-plane package
