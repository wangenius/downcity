...
- For what usage actually records, read [Usage Event Model](/en/payments/usage/event-model)
- For how usage combines with charging logic, read [Billing Integration](/en/payments/usage/billing-integration)
