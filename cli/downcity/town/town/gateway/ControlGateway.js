...
import { registerAgentSdkPublishRoutes, } from "@/town/gateway/api/AgentSdkPublishRoutes.js";
import { buildPlatformAgentsResponse, buildPlatformConfigStatusResponse, buildPlatformModelResponse, inspectPlatformAgentDirectory, listKnownPlatformAgents, readPlatformConfigFileStatus, readRequestedPlatformAgentId, resolvePlatformAgentById, resolveSelectedPlatformAgent, } from "@/town/gateway/AgentCatalog.js";
import { executeAgentProjectShellCommand, initializePlatformAgentProject, inspectManagedAgentRestartSafety, pickPlatformAgentDirectoryPath, restartManagedAgentByProjectRoot, startManagedAgentByProjectRoot, stopManagedAgentByProjectRoot, updatePlatformAgentExecution, } from "@/town/gateway/AgentActions.js";
...
import { CONTROL_PLANE_AUTH_ROUTE_POLICIES, createRouteAuthGuardMiddleware, } from "@/town/auth/RoutePolicy.js";
