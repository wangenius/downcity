...
This is common for subscription or plan-based studios.

### Scenario 2: analytics now, billing later

Many studios first need to know which models, studios, and users consume the most before they need a full billing engine.
...
Studios vary too much: per-call pricing, per-model pricing, quota-based pricing, and included usage plus overage billing all have different rules.
