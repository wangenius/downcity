...
description: "The usage query surface exposed by @downcity/services, and how town-side and admin-side callers read it."
---
...
- admin-side: which towns, models, and users are consuming resources?
...
### Town-side callers can read usage too

Usage is not only internal operational data. It can be part of the town experience.
