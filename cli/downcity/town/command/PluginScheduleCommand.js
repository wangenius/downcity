...
import { normalizeScheduledJobStatus, parsePositiveIntOption, resolvePluginScheduleProjectRoot, validateAgentProjectRoot, } from "../shared/PluginTargetSupport.js";
import { parseBoolean } from "../shared/IndexSupport.js";
/**
 * 注入 ActionSchedule 管理命令通用选项。
 */
function addPluginScheduleOptions(command) {
    return command
...
export function registerPluginScheduleCommands(plugin) {
    ...
    addPluginScheduleOptions(schedule
        .command("info <jobId>")
        .description("查看单个延迟 action 任务详情")).action(async (jobId, opts) => {
    ...
    addPluginScheduleOptions(schedule
        ...
        .description("取消一个尚未执行的延迟 action 任务")).action(async (jobId, opts) => {
...
//# sourceMappingURL=PluginScheduleCommand.js.map