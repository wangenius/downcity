...
- the capability should be reused across many bays
- it is more than before or after logic and needs its own service or tables
- you want bay-side callers to reach it through a stable service boundary
...
## How bay-side callers reach services

Once mounted, services still look like normal services from the bay side:
...
Services add capability into City. The bay-side calling surface is still [@downcity/city](/en/docs/city/packages/city/gate).

## Read next

- For unified bay-side service calls, read [@downcity/city](/en/docs/city/packages/city/gate)
