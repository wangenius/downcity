...
- 看某个项目是否运行，用 `city agent status`
- 看全局有哪些 agent，用 `city agent list`

## 一个高频误区

很多人会问：“既然我用的也是 `city agent ...` 命令，那为什么还要强调 agent 是独立运行时？”
