...
description: Explains console registry writes, how the execution context surface connects runtime capability, and how shell injects environment
---
...
flowchart TD
  ...
  F["city managed plugin or studio plugin"] --> G["agent API"]
