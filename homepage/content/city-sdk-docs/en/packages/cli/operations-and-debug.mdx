...
description: "The boundary between fed, city, Admin City, and direct database inspection, and when the CLI is the better tool."
---
...
- For the basic `fed` / `city` entries, read [CLI Quickstart](/en/city-sdk-docs/packages/cli/quickstart)
