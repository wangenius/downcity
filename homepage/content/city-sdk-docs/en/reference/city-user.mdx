---
title: User City
description: How town clients read the model directory and call AIService or custom services.
---
...
The most important point is not the method list. `User City` unifies three kinds of town-side calls:
...
So from the town side, `User City` is not only "the thing that calls models." It is the unified user-context entry into City.
...
This is useful for dynamic menus, debug tooling, or town-side discovery of callable services.
