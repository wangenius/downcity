...
- Only directories that are not initialized yet enter the initialize-on-start flow, which creates `PROFILE.md`, `SOUL.md`, `downcity.json`, and `.downcity/` before starting the runtime.
