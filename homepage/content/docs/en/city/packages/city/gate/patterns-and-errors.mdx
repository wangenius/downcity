...
description: "Common Gate combinations in real studios, and how to reason about token, model, and service-related errors."
---
...
- `@downcity/city`
- Gate exports from `@downcity/city`

### AI studio with minimal auth

- `@downcity/city`
- Gate exports from `@downcity/city`
- `@downcity/services`

### AI studio with usage and payment
...
- the token expired
- the `studio_id` does not match the token
- the studio has been paused
...
3. then compare `studio_id`, `user_token`, service id, action id, and model id
