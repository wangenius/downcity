...
4. Business layer: services, plugins, and plugin dependency assets
...
In other words, assets are best understood as plugin dependencies, not as a third workflow owner beside services and plugins.
