...
This is common for subscription or plan-based bays.

### Scenario 2: analytics now, billing later

Many bays first need to know which models, bays, and users consume the most before they need a full billing engine.
...
Bays vary too much: per-call pricing, per-model pricing, quota-based pricing, and included usage plus overage billing all have different rules.
