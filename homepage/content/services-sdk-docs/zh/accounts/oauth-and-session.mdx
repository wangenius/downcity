...
如果你现在要真正把 Google 登录配起来，继续读 [Google 登录配置](/zh/services-sdk-docs/accounts/google-login)。

如果你现在要真正把微信网站登录配起来，继续读 [微信登录配置](/zh/services-sdk-docs/accounts/wechat-login)。
