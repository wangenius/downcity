 ...
 * - 本测试覆盖 moonshot provider，防止默认 baseUrl 与运行时 SDK 配置漂移。
 */
...
test("discoverProviderModels: moonshot uses ai endpoint by default", async () => {
...
test("discoverProviderModels: moonshot respects explicit cn endpoint", async () => {
  const originalFetch = globalThis.fetch;
  const calls = [];
