...
5. Infrastructure layer: City runtime, auth, env, bay-scoped routing
...
flowchart LR
  ...
  subgraph Infra["Infrastructure"]
    INFRA["City<br/>service runtime / auth / env / bays"]
...
- owns bay-scoped auth, runtime env, and built-in bay/env tables
