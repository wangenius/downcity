---
title: Town Registration, Execution Context, and Shell Flow
...
# Town Registration, Execution Context, and Shell Flow
...
flowchart TD
  ...
  F["city managed plugin or town plugin"] --> G["agent API"]
