...
- existing Sessions commit Agent instruction, env, and plugin changes before their next model turn
- an in-flight provider request and its tool calls keep the env that was effective when that model turn began
