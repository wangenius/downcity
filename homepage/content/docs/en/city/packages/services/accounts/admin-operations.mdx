...
description: "How accountsService() works with AdminClient in trusted environments for users, sessions, and related admin-side reads."
---
...
## Why this is tied to `AdminClient`
