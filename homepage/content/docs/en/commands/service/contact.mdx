...
The link code automatically includes A's currently reachable address. Public deployments prefer `DOWNCITY_PUBLIC_URL` / `DOWNCITY_PUBLIC_HOST`; otherwise Downcity uses the runtime host or a local network interface address.
