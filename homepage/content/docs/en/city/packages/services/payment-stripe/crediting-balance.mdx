...
### Studio is for attribution, not wallet ownership

If you want to remember which studio page initiated a recharge, store it in metadata rather than splitting the wallet itself.
