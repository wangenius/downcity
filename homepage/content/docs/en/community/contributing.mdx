---
title: Contributing
description: How to contribute to Downcity
---

# Contributing

Thank you for your interest in contributing to Downcity! This guide will help you get started.
...
1. Push to your fork
2. Create pull request to `wangenius/downcity:main`
3. Fill PR template:
...
- In `cli/city/src`, you can use `@/` path aliases (mapped to `src`), and `pnpm build` will rewrite them to runnable relative paths in `bin`
...
# 3. Commit changes
git add .
git commit -m "feat: add Discord bot plugin"
...
- [Architecture](/en/docs/concepts/architecture) - System architecture
- [Plugin Commands](/en/products-docs/town-cli/plugin/plugin) - User-facing plugin command docs
- [API Reference](/en/docs/reference/api) - Runtime HTTP API docs

### Community

- [Discord](https://discord.gg/downcity) - Real-time chat
- [Telegram Community](https://t.me/+iozIHyXr-BJhNjE1) - Q&A
- [GitHub Issues](https://github.com/wangenius/downcity/issues) - Bug reports
...
Thank you for contributing! Your help makes Downcity better for everyone.

Contributors are recognized in:
- [Contributors](https://github.com/wangenius/downcity/graphs/contributors)
- Release notes
- Annual highlights
...
1. Look for [good first issues](https://github.com/wangenius/downcity/labels/good-first-issue)
2. Join the [Discord community](https://discord.gg/downcity)
3. Start coding! 🚀
