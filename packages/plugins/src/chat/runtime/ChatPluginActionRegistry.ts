...
const CHAT_SEND_HELP_TEXT = [
  "",
  "消息协议：",
  "  frontmatter metadata 字段语义与 `bay chat send` 参数一致。",
  ...
  "  cat <<'EOF' | bay chat send --stdin --chat-key <chatKey>",
  "  第一行",
  "  第二行",
  "  EOF",
  "  bay chat send --text-file ./result.md --chat-key <chatKey>",
  "",
  "说明：",
...
const CHAT_REACT_HELP_TEXT = [
  "",
  "常用示例：",
  "  bay chat react --emoji '👍'",
  "  bay chat react --emoji '✅' --message-id <messageId>",
  "  bay chat react --chat-key <chatKey> --message-id <messageId> --emoji '🔥'",
  "",
  "说明：",
