...
description: "用 downcity 查看 models、schema、表数据，以及它和 City 数据层的关系。"
---
...
- 查看 Federation AIService 暴露出的模型
- 选择 City base 并通过 City 登录
...
CLI 本身不替你定义数据模型，它只是把 Federation里已经存在的数据层摊开给你看。

这也是为什么这页要和 [Store 与 Table](/zh/city-sdk-docs/packages/city/store-and-table) 一起理解：
...
- 想知道 CLI 在运维里怎么用，读 [运维与排查](/zh/city-sdk-docs/packages/cli/operations-and-debug)
- 想理解这些表的来源，读 [Store 与 Table](/zh/city-sdk-docs/packages/city/store-and-table)
