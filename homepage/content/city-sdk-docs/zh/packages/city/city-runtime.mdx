---
title: City 运行时
description: "CityBase 实例、runtime、router、serve 和统一入口在 @downcity/city 里的角色。"
---
...
- 你只想知道产品前端怎么调 City：优先读 [@downcity/city](/zh/city-sdk-docs/packages/city/city)
...
City 是服务端长期运行容器。产品侧真正调用它用的是 [@downcity/city](/zh/city-sdk-docs/packages/city/city)。
