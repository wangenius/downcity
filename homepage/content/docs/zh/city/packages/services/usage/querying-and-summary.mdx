...
- 想理解 usage 本身记录什么，读 [Usage 事实模型](/docs/city/packages/services/usage/event-model)
- 想把 usage 接到套餐和收费规则，读 [和计费逻辑怎么配](/docs/city/packages/services/usage/billing-integration)
