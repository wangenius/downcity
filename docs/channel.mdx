...
也就是说，不再把 `@attach` 暴露给模型或用户侧。核心解析在 [ChatMessageMarkup.ts](/Users/wangenius/Documents/github/shipmyagent/packages/downcity/src/services/chat/runtime/ChatMessageMarkup.ts) 和 [ChatSendMetadata.ts](/Users/wangenius/Documents/github/shipmyagent/packages/downcity/src/services/chat/runtime/ChatSendMetadata.ts)。
