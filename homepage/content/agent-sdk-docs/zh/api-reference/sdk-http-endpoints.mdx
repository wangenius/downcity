---
title: SDK HTTP 端点
description: Town 为 RemoteAgent 暴露的最小 HTTP session 接口集合
---
...
它们由 [`@downcity/server`](/zh/agent-sdk-docs/local-agent/http-and-rpc) 提供的 `AgentHTTP` 暴露，可作为独立 HTTP server 启动，也可挂到 Town gateway 等任何 Hono server 上。
