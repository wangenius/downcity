...
Downcity lets a new studio start from the frontend, extension, or app and connect to an already deployed City. You can validate the studio UX first, then decide how much studio-specific backend you really need.
