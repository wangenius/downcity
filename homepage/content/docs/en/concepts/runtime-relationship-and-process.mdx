...
description: Collaboration model and startup/process order across Downcity runtime, Console, agent, execution context, session, and plugin runtime
---
...
- `downcity` governs local runtime and managed agent registration
