...
description: "Use @downcity/studio-cli to inspect models, schema, and table data, and understand how that connects to the City data layer."
---
...
- `@downcity/studio-cli` owns the human inspection and debugging entry
...
- For operational decision-making with the CLI, read [Operations and Debugging](/en/docs/city/packages/studio-cli-terminal/operations-and-debug)
