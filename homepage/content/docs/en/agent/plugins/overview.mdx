...
1. [Which built-in plugins exist today](/en/docs/agent/plugins/built-in-plugins)
2. [Plugin configuration](/en/docs/agent/plugins/configuration)
3. [Plugin actions](/en/docs/agent/plugins/plugin-actions)
4. [Plugin hooks](/en/docs/agent/plugins/plugin-hooks)
5. [Custom plugin](/en/docs/agent/plugins/custom-plugin)
