...
> 这页保留为命令入口。更完整的 Plugin 结构说明见 [Plugin 总览](/zh/docs/agent/plugins/overview)、[当前有哪些内建 Plugin](/zh/docs/agent/plugins/built-in-plugins) 和 [Plugin HTTP 注入](/zh/docs/agent/plugins/plugin-http)。
