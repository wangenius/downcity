...
If your Console UI is elsewhere, open the extension settings page. The page is split into two parts:

- `Server / Auth`: set Console Host and Port, then paste a Bearer token
- `Agent / Channel`: after the connection succeeds, choose the default Agent and default Channel Chat
