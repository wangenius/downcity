...
## 0.1) 默认 system（Agent.md + Soul.md（可选）+ DefaultPrompt）
...
当前实现的“简化版运行逻辑（system = Agent.md + Soul.md（可选） + DefaultPrompt、无 simulation、按需加载历史）”说明见：`docs/runtime-simplified.md`。
