...
公开仓库里保留了 `cities/edge` 作为开发者快捷示例。Downcity 官方私有 Worker 实现维护在公开仓库之外。
...
## 从 `cities/edge` 快捷示例开始

仓库里的 [cities/edge/src/index.ts](/Users/wangenius/Documents/github/downcity/cities/edge/src/index.ts:1) 已经覆盖大多数项目需要的接入细节，包含这些关键点：
...
- 如果你需要完整快捷示例，直接看 [cities/edge/src/index.ts](/Users/wangenius/Documents/github/downcity/cities/edge/src/index.ts:1)
