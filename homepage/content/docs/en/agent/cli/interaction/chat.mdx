...
bay agent chat --to my-agent --message "Summarize this repo"
bay agent chat --to my-agent --message "Return JSON" --json
```
...
```bash
bay agent chat --to my-agent --message "Summarize the current repository structure"
```
