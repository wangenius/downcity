...
This path does not require product code to create an AI SDK provider. The host
converts the `CityModel` to a runtime model before passing it to the local Agent. A Session with its own model instance takes priority.
