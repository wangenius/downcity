...
- For directories that are not initialized yet, Global Agents also supports initialize-on-start: it creates `PROFILE.md`, `SOUL.md`, `ship.json`, and `.ship/` before starting the runtime.
