...
6. If the product has its own backend, City uses `city.connect(bureau_url)` to call Bureau services
...
City does not need the Bureau SDK to call an independent Bureau service:
