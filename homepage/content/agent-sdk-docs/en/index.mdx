...
2. [Plugins](/en/agent-sdk-docs/plugins/overview)
3. [Remote Agent](/en/agent-sdk-docs/remote-agent/quickstart)
4. [Sessions](/en/agent-sdk-docs/sessions/overview)
5. [API reference](/en/agent-sdk-docs/api-reference/agent-class)
