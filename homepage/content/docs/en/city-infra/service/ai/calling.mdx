...
description: SDK pathway (UserClient) and OpenAI-compatible pathway (curl / OpenAI SDK / pi-agent) calling examples.
---
...
| Scenario | Pathway |
|---|---|
| Your own product code, simple prompt → text | SDK |
| Streaming output to your own UI | SDK |
| pi-agent agent conversations | OpenAI-Compatible |
